            ...
            <div class="card">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Task Reminders</li>
                    </ol>
                </nav>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <?php 
                                ...
                                $newgrid = new CRMGrid(TaskReminder::class, 'Task Reminders', 
                                    array(
                                    'column_configs' => array(
                                        'id'=> array('header'=>'ID', 'type' => 'text', 'length' => 5),
                                        'task_id'=> array('header'=>'Task ID', 'type' => 'text', 'length' => 5),
                                        'remind_date_time'=> array('header'=>'Remind On', 'length' => 20),
                                        'subject'=> array('header'=>'Subject', 'length' => 20),
