            ...
            <div class="card">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Project Contacts</li>
                    </ol>
                </nav>
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <?php 
                                use WinstarCRM\ProjectContact;
                                use WinstarCRM\Helpers\CRMGrid;

                                $newgrid = new CRMGrid(ProjectContact::class, 'Project Contacts', 
                                    array(
                                    'column_configs' => array(
                                        ...
                                        'contact_id'=> array('header'=>'Contact ID', 'type' => 'text', 'length' => 5)
                                    ),
                                    'table_config' => array(
                                        'is_editable' => true,
                                        'enable_delete' => true,
