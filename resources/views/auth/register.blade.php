      ...
      <div class="card-body register-card-body">
        ...
        <form method="POST" action="{{ route('register') }}">
          ...
          <div class="input-group mb-3">
            ...
            <autocomplete-component class="input-group mb-3" :show-delete="false" css-class="form-control" placeholder="company" display-column="name" name="company_id" relation="company">
                <div class="input-group-append">
                  <div class="input-group-text">
