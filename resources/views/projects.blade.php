        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <?php 
                                use WinstarCRM\Project;
                                use WinstarCRM\Helpers\CRMGrid;

                                $newgrid = new CRMGrid(Project::class, 'Projects Table', 
                                    array(
                                    'column_configs' => array(
                                        ...
                                        'start_date' => array('header'=>'Start', 'length' => 50),
                                        'estimated_end_date' => array('header'=>'End', 'length' => 50),
